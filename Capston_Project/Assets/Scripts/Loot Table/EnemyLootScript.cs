...
public class EnemyLootScript : MonoBehaviour
{
    ...
    public void CalculateLoot()
    {
        ...
        if(calcDropChance <= dropChance)
        {
            ...
            Vector3 spawnPos = playerPos + playerDirection * spawnDistance; // Gets the players position
            for (int j = 0; j < LootTable.Count; j++)
            {
                ...
                {
                    /*Vector3 spawnPos = player.transform.position; // Gets the players position
